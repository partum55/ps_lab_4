...
H0: mu1 = mu2 vs H1: mu1 != mu2 with sigma1^2 = sigma2^2 = 1 (known).

We use the z-test for difference of means because population variances are known and equal.

General form of rejection region (two-sided, level alpha = 0.05): reject H0 if |Z| > z_{1-\alpha/2} = 1.96, where
...
H0: sigma1^2 = sigma2^2 vs H1: sigma1^2 > sigma2^2. Use the F-test (ratio of sample variances).

For samples from normal distributions, the statistic F = S1^2 / S2^2 follows an F distribution with (n1-1, n2-1) degrees of freedom under H0.
Rejection region (one-sided, alpha=0.05): reject H0 if F > F_{1-alpha; n1-1, n2-1}.
